...
const Header = () => {
    ...
    const triggerSuccess = (msg: string) =>
        setSuccessMsg({ open: true, message: msg });
    const triggerError = (msg: string) =>
        setAuthError({ open: true, message: msg });
    ...
    const handleLogin = async (email: string, password: string) => {
        try {
            ...
            if (!response.ok)
                throw new Error(
                    data.message || data.error || "Credential error",
                );
    ...
    return (
        <>
            ...
            <ResetPasswordModal
                ...
                onResetPassword={(email) => {return Promise.resolve();}}
                onSwitchToLogin={handleSwitchToLogin}
            />
