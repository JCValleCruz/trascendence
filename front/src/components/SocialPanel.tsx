    ...
    return (
        <Paper elevation={8} sx={{ width: 280, bgcolor: '#121212', color: 'white', borderRadius: 2, border: '1px solid #333' }}>
            <Box sx={{ p: 2, bgcolor: '#1e1e1e', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Typography variant="subtitle1" sx={{ fontWeight: 'bold' }}>{"SOCIAL ->"}</Typography>
            ...
            <List sx={{ py: 0 }}>
                ...
                <Collapse in={showPending}>
                    {pending.map(p => (
                        <ListItem key={p.sender_id} secondaryAction={<Box><IconButton size="small" color="success"><CheckIcon fontSize="small" /></IconButton><IconButton size="small" color="error"><CloseIcon fontSize="small" /></IconButton></Box>}>
